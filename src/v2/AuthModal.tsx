/* ================================================================
   ...
   현재는 목업: "Google로 계속하기" → onLogin(). 실연동 시 실제 OAuth로 교체.
   ================================================================ */
    ...
    <Dialog open onOpenChange={(o) => !o && onClose()}>
      <DialogContent className="max-w-sm">
        ...
        <div className="pt-1">
          ...
          <button
            onClick={onLogin}
            className="mt-6 flex h-11 w-full items-center justify-center gap-2.5 rounded-lg border border-border bg-white text-[14px] font-semibold text-card-foreground transition-all hover:border-primary/40 hover:shadow-[0_4px_12px_rgba(194,65,12,0.12)]"
          >
