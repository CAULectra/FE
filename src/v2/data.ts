  ...
  chapters: [
    {
      ...
      blocks: [
        ...
        { kind: "callout", emoji: "📌", text: "Σ-프로토콜의 세 화살표(a → c → r)는 이후 등장하는 모든 프로토콜의 공통 뼈대 — 그림째로 기억해두면 Schnorr·서명까지 한 번에 풀린다." },
    ...
    },
    {
      ...
      blocks: [
        ...
        { kind: "callout", emoji: "⚠️", text: "세 성질은 '누가 무엇으로부터 보호되는가'로 구분해서 서술할 것 — 완전성은 정직한 P, 건전성은 V, 영지식성은 P의 비밀을 보호한다." },
  ...
  chapters: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { kind: "callout", emoji: "💡", text: "미로에서 막다른 길 = promising 거짓. 백트래킹의 직관은 이 한 줄이 전부다 — 나머지는 문제별 유망 함수 설계." },
  ...
  chapters: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { kind: "callout", emoji: "⚠️", text: "count-to-infinity 그림은 시험 단골 — poisoned reverse가 무엇을 해결하고 무엇은 해결 못 하는지까지 세트로 정리할 것." },
